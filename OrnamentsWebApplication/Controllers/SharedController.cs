    ...
    public class SharedController : Controller
    {
        ...
        public JsonResult UploadImage()
        {
            ...
            try
            {
                ...
                var path = Path.Combine(Server.MapPath("~/content/Design/images/"), fileName);

                file.SaveAs(path);

                result.Data = new { Success = true, ImageURL = string.Format("/content/Design/images/{0}", fileName) };
